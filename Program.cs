...
namespace LINQPractice {
    class Program {
        static void Main(string[] args) {
            ...
            var productsWithPricesInRange10To20 = from product in products where product.Price >= 10.00 
                                                & product.Price <= 20.00 select product;
            ...
            var productsWithPricesInRange10To20OrderedByPriceAsc = from product in products where product.Price >= 10.00 
                                                                 & product.Price <= 20.00 orderby product.Price select product;

            var productsWithPricesInRange10To20OrderedByPriceAscFunctional = products.Where(product => (product.Price >= 10.00 
                                                                           & product.Price <= 20.00)).OrderBy(product => product.Price);
            ...
            var titlesForProductsWithPricesInRange10To20OrderedByTitleAsc = from product in products where product.Price >= 10.00 & 
                                                                            product.Price <= 20.00 orderby product.Title select product.Title;

            var titlesForProductsWithPricesInRange10To20OrderedByTitleAscFunctional = products.Where(product => (product.Price >= 10.00 & product.Price <= 20.00))
                                                                                    .OrderBy(product => product.Title).Select(product => product.Title);
            ...
            var idsForProductsWithPricesInRange10To20OrderedByIDDesc = from product in products where product.Price >= 10.00 & 
                                                                       product.Price <= 20.00 orderby product.ID descending select product.ID;

            var idsForProductsWithPricesInRange10To20OrderedByIDDescFunctional = products.Where(product => (product.Price >= 10.00 & product.Price <= 20.00))
                                                                                .OrderByDescending(product => product.ID).Select(product => product.ID);
            ...
            var kitchenProductsOrderedByStockedQuantity = from product in products where product.Category == ProductCategory.Kitchen 
                                                        orderby product.StockedQuantity descending select product;

            var kitchenProductsOrderedByStockedQuantityFunctional = products.Where(product => (product.Category == ProductCategory.Kitchen))
                                                                    .OrderByDescending(product => product.StockedQuantity);
            ...
            var computerProductsCostingMoreThan100 = from product in products where product.Category == ProductCategory.Computers
                                                   & product.Price > 100.00 select product;

            var computerProductsCostingMoreThan100Functional = products.Where(product => (product.Category == ProductCategory.Computers) 
            ...
            var petProductsLowestToHighestPrice = from product in products where product.Category == 
                                                ProductCategory.Pet orderby product.Price ascending select product;

            var petProductsLowestToHighestPriceFunctional = products.Where(product => product.Category == 
                                                          ProductCategory.Pet).OrderBy(product => product.Price);
            ...
            var productsInIDRange2000To2999OrderedByID = from product in products where product.ID >= 2000 
                                                       & product.ID <= 2999 orderby product.ID select product;

            var productsInIDRange2000To2999OrderedByIDFunctional = products.Where(product => (product.ID >= 2000 
                                                                 & product.ID <= 2999)).OrderBy(product => product.ID);
            ...
            var titlesForProductsInIDRange2000To2999OrderedByTitleLength = from product in products where product.ID >= 2000 & product.ID 
                                                                         <= 2999 orderby product.Title.Length ascending select product.Title;

            var titlesForProductsInIDRange2000To2999OrderedByTitleLengthFunctional = products.Where(product => (product.ID >= 2000 & product.ID <= 2999))
                                                                                   .OrderBy(product => product.Title.Length).Select(product => product.Title);
            ...
            var lowStock = from product in products where product.StockedQuantity < 20 
                         select new { Title = product.Title, StockedQuantity = product.StockedQuantity };

            var lowStockFunctional = products.Where(product => product.StockedQuantity < 20)
                                   .Select(product => new { Title = product.Title, StockedQuantity = product.StockedQuantity });
            ...
            var lowStockOrderedByStockedQuantity = from product in products where product.StockedQuantity < 20 orderby product.StockedQuantity 
                                                 select new { Title = product.Title, StockedQuantity = product.StockedQuantity };

            var lowStockOrderedByStockedQuantityFunctional = products.Where(product => product.StockedQuantity < 20).OrderBy(product => product.StockedQuantity)
                                                           .Select(product => new { Title = product.Title, StockedQuantity = product.StockedQuantity });
